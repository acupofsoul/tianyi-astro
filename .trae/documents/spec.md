...
| 天文奇观页 | 超新星爆发 | 展示超新星爆发的视觉效果和过程 |
| 天文奇观页 | 星云形成 | 展示星云的形成和演化过程 |
| 天文奇观页 | 行星环系统 | 展示土星等行星的环系统 |
| 天文奇观页 | 流星雨 | 展示流星雨的视觉效果 |
| 星系概念页 | 星系类型介绍 | 展示不同类型星系的特征和示例（椭圆星系、螺旋星系、不规则星系等） |
| 星系概念页 | 星系形成演化 | 介绍星系的形成过程和演化历史 |
| 星系概念页 | 星系团和超星系团 | 介绍星系的聚集形式 |
| 星系概念页 | 暗物质和暗能量 | 介绍宇宙中的暗物质和暗能量概念 |
...
| 天文奇观页 | 超新星爆发 | 展示恒星爆炸的视觉效果，包括冲击波和光线爆发 |
| 天文奇观页 | 星云形成 | 展示气体和尘埃云的形成过程，带有色彩渐变效果 |
| 天文奇观页 | 行星环系统 | 展示土星等行星的环系统，包括环的结构和组成 |
| 天文奇观页 | 流星雨 | 展示流星划过夜空的视觉效果，可调整观察方向 |
| 星系概念页 | 星系类型介绍 | 卡片式布局，每个星系类型带有图片和详细描述，包括椭圆星系、螺旋星系、不规则星系等 |
| 星系概念页 | 星系形成演化 | 时间轴形式展示，配有动画和图表，展示星系从形成到演化的过程 |
| 星系概念页 | 星系团和超星系团 | 展示星系的聚集形式，包括不同尺度的星系结构 |
| 星系概念页 | 暗物质和暗能量 | 通过可视化效果展示暗物质和暗能量的概念和作用 |
